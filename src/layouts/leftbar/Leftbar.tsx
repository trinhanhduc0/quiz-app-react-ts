...
const LeftBar: FC<RightBarProps> = ({ isOpen, toggle }) => {
  ...
  const languageDropdownRef = useRef<HTMLLIElement | null>(null);
  ...
  return (
    ...
    >
      ...
      <ul className="mt-4 px-3 space-y-1">
        ...
        {/* Language Dropdown */}
        <li className="relative mt-2" ref={languageDropdownRef}>
          <div
